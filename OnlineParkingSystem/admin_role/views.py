...
def getScatterdata(request):
    ...
    axis.scatter(frame.index,frame.total_price,s=frame.payment_remaining,c=color,cmap="RdYlGn",alpha=0.5)
    data_set = set(zip(frame.index,frame.total_price-0.2))
    ...
    axis.set_ylabel("Payment Remaining")
    ...
    axis.legend([Circle((0,0), fc='r'),Circle((0,0), fc='g')], ["Payment Done","Payment Remaining"])
